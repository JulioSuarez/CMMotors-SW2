...
const ExisteCliente2 = (input) => {
    ...
    if (valor.length >= minimo_letras) {
        ...
        fetch("https://www.tecnoweb.org.bo/inf513/grupo07sa/proyecto2/public/Existe_Cliente", {
            headers: {
                "X-CSRF-TOKEN": token,
            },
            method: "post",
...
const existeNro_coti = (inpNroCoti, e) => {
    ...
    if (valor.length >= minimo_letras) {
        ...
        let Formulario = new FormData();
        Formulario.append("valor", valor);
        fetch("https://www.tecnoweb.org.bo/inf513/grupo07sa/proyecto2/public/existeCotizar", {
            headers: {
                "X-CSRF-TOKEN": token,
            },
            method: "post",
