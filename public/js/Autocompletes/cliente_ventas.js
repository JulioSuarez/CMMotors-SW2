    ...
    fetch('/inf513/grupo07sa/proyecto2/public/api/ProductoApi/', {
        ...
        .then((data) => {
            ...
            if (data.precio_venta_con_factura != arrayMonto[i - 1]) {
                ...
                img.src = "https://tecnoweb.org.bo/inf513/grupo07sa/proyecto2/public/img/fotosProductos/" + data.foto;
        ...
        .catch((e) => {
            ...
            let img = document.getElementById('img_producto_venta' + i);
            img.src = "https://tecnoweb.org.bo/inf513/grupo07sa/proyecto2/public/img/fotosProductos/default.png";
