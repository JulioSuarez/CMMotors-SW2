            ...
            <div
                ...
                <div class="flex flex-col ">
                    ...
                    <input
                      ...
                      border-gray-300 rounded
                        ...
                        value="{{ old('cod_producto', $p->cod_producto) }}" oninput="noEspacios()" />
                </div>
                ...
                <div class="flex flex-col  ">
                    ...
                    <input
                        ...
                        value="{{ old('cod_oem', $p->cod_oem) }}" oninput="noEspacios()"/>
                </div>
                ...
                <div class="flex flex-col sm:col-span-2">
                    ...
                    <input
                        ...
                        focus:outline-none focus:border focus:border-blue-900 uppercase"
                        id="nombre_prod" name="nombre" type="text" autocomplete="off"
                        value="{{ old('nombre_prod', $p->nombre) }}" />
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    <input id="marca"
                        ...
                        focus:outline-none focus:border focus:border-blue-900 uppercase"
                        name="marca" type="text" value="{{ old('marca', $p->marca) }}" />
                </div>
                ...
                <div class="flex flex-col">
                    ...
                    focus:outline-none focus:border focus:border-blue-900 uppercase"
                        name="procedencia" type="text" value="{{ old('procedencia', $p->procedencia) }}" />
                </div>
                <div class="flex flex-col">
                    ...
                    <input id="origen"
                        class=" pl-3 text-gray-500 font-normal w-full h-8 text-sm border-gray-300 rounded border
                            focus:outline-none focus:border focus:border-blue-900 uppercase"
                        name="origen" type="text" value="{{ old('origen', $p->origen) }}" />
                </div>

                <div class="flex flex-col lg:mt-1 ">
                    @include('VistaProductos.Modal_crear_proveedo')

                    <div class="flex justify-between mb-1 pl-3 ">
                    ...
                    <select name="proveedor" id="select_proveedor"
                        ...
                        <option value="{{ $p->id_proveedor }}" selected>{{ $p->nombre_proveedor }} </option>
                ...
                <div class="flex flex-col ">
                    ...
                    @if($p->fecha_expiracion == "2100-09-26")
                        <input id="fecha_expiracion"
                            class="pl-3  text-gray-500 font-normal w-full h-8  text-sm border-gray-300 rounded border
                                focus:outline-none focus:border focus:border-blue-900 uppercase"
                            name="fecha_expiracion" type="date" autocomplete="off"
                            value="{{ old('fecha_expiracion', $p->echa_expiracion) }}" />
                    @else
                        <input id="fecha_expiracion"
                            class="pl-3  text-gray-500 font-normal w-full h-8  text-sm border-gray-300 rounded border
                                focus:outline-none focus:border focus:border-blue-900 uppercase"
                            name="fecha_expiracion" type="date" autocomplete="off"
                            value="{{ old('fecha_expiracion', $p->fecha_expiracion) }}" />
                    @endif
                </div>
                ...
                <div class="flex flex-col ">
                    ...
                    <input id="estante"
                        class="text-center text-gray-500 font-normal  h-8  text-sm border-gray-300 rounded border
                            focus:outline-none focus:border focus:border-blue-900 uppercase"
                        name="estante" type="text" autocomplete="off" value="{{ old('estante', $p->estante) }}" />
                </div>
                    ...
                    <div class="flex justify-around text-center items-end">
                        <div class="flex flex-col items-center ">
                            ...
                            <input
                                ...
                                value="{{ old('precio_pp', $p->precio_compra) }}" />
                        </div>
                        {{-- @dd($p->precio_venta_con_factura) --}}
                        ...
                        <div class="flex flex-col items-center ">
                            ...
                            <input
                                ...
                                autocomplete="off"
                                value="{{ old('precio_sin_factura_pp', $p->precio_venta_sin_factura) }}" />
                        </div>
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <input
                                ...
                                autocomplete="off"
                                value="{{ old('precio_factura_pp', $p->precio_venta_con_factura) }}" />
                        </div>
                    ...
                    <div class="flex justify-around items-center ">
                        ...
                        {{-- @foreach ($unidades as $u)
                            ...
                            <label class="text-gray-700 text-sm " for="piezas">PZA</label>
                                ...
                                <label class="text-gray-700 text-sm " for="piezas">PZA</label>
                            @endif
                            <input type="radio" id="piezas" name="unidad" class="" value="PZA">
                            <label class="text-gray-700 text-sm " for="piezas">{{$u}}</label>
                        ...
                        <div class=" ">
                            @if ($p->unidad == "PZA")
                                <input type="radio" id="piezas" name="unidad" value="PZA" checked>
                                <label class="text-gray-700 text-sm " for="piezas">PZA</label>
                            @else
                                <input type="radio" id="piezas" name="unidad" class="" value="PZA">
                                <label class="text-gray-700 text-sm " for="piezas">PZA</label>
                        ...
                        <div>
                            @if (strtoupper($p->unidad) == "KIT")
                                <input type="radio" id="kit" name="unidad" value="KIT" checked>
                        ...
                        <div>
                            @if (strtoupper($p->unidad) == "MTS")
                                <input type="radio" id="mts" name="unidad" value="Mts" checked>
                        ...
                        <div>
                            @if (strtoupper($p->unidad) == "LTS")
                                <input type="radio" id="lts" name="unidad" value="Lts" checked>
                        ...
                        <div>
                            @if (strtoupper($p->unidad) == "KG")
                                <input type="radio" id="kg" name="unidad" value="Kg" checked>
                ...
                <div
                    ...
                    <div class="flex flex-col ">
                        ...
                        <input
                            ...
                            placeholder="0" value="{{ old('cantidad', $p->cantidad) }}" />
                    </div>
                    <div class="flex flex-col">
                        ...
                        <input
                            ...
                            value="{{ old('cant_minima', $p->cant_minima) }}" />
                    </div>
                </div>
                ...
                <div class="sm:col-span-2  ">
                    ...
                    <div class="flex sm:flex justify-around 2xl:pl-1 items-center ">
                        ...
                        <div>
                            @if (strtoupper($p->tienda) == "FERRETERIA")
                                <input type="radio" id="ferreteria" name="tienda" value="Ferreteria" checked>
                        ...
                        <div>
                            @if (strtoupper($p->tienda) == "DEPOSITO TALLER")
                                <input type="radio" id="deposito" name="tienda" value="Deposito Taller" checked>
                        ...
                        <div>
                            @if (strtoupper($p->tienda) == "DEPOSITO FERRETERIA")
                                <input type="radio" id="deposito_fe" name="tienda" value="Deposito Ferreteria" checked>
                                <label class="text-gray-700 text-xs sm:text-base" for="deposito_fe">
                                    Deposito Ferreteria</label>
                            @else
                                <input type="radio" id="deposito_fe" name="tienda" value="Deposito Ferreteria">
                                <label class="text-gray-700 text-xs sm:text-base" for="deposito_fe">
                                    Deposito Ferreteria</label>
                            @endif
                        </div>
                        ...
                        {{-- <div>
                            <input type="radio" id="ferreteria" name="tienda" value="Ferreteria">
                            <label class="text-gray-700 text-xs lg:text-sm" for="ferreteria">
                                Ferreteria</label>
                        </div>
                        <div>
                            <input type="radio" id="deposito" name="tienda" value="Deposito Taller">
                            <label class="text-gray-700 text-xs lg:text-sm" for="deposito">
                                Deposito Taller</label>
                        </div> --}}
                    </div>
                </div>
...
{{-- @dd(($p->estado == "Habilitado")); --}}
                    <div class="flex justify-around 2xl:w-2/4  items-center ">
                        <div class=" ">
                            {{-- Habilidato --}}
                            @if (strtoupper($p->estado) == "HABILITADO")
                            ...
                            @else
                                <input type="radio" id="est_habilitado" name="estado" class=""
                                    value="HABILITADO">
                                <label class="text-gray-700 text-sm " for="est_habilitado">HABILITADO</label>
                            @endif
                        </div>
                        <div>
                            @if (strtoupper($p->estado) == "DESHABILITADO")
                                <input type="radio" id="est_desabilitado" name="estado" value="DESHABILITADO" checked>
                ...
                xl:col-span-2 xl:row-start-1 xl:col-start-3 xl:p-4">
                    ...
                    <div class="mt-4 flex flex-col items-center ">
                        <img id="img_fotoventas" src="{{ asset('img/fotosProductos/' . old('foto', $p->foto)) }}"
        ...
        {{-- <div class=" flex flex-row-reverse justify-between sm:px-6 px-3   xl:mx-20">
            <button type="submit" class=" bg-blue-500 py-2 px-3 text-lg text-gray-100  rounded-xl">
                Guardar
            </button>
        </div> --}}
    </form>
