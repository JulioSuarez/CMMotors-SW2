            ...
            <div class="py-4 px-6 w-2/3 mx-4 mt-8 bg-white rounded-xl grid grid-cols-1 lg:grid-cols-2 gap-y-5  gap-x-10">
                ...
                <div>
                    ...
                    <div class="relative mt-0 mb-1">
                        ...
                        <input
                            ...
                            id="nit_buscar" name="nit" type="number" value="{{ old('nit') }}" autofocus="true" autocomplete="off" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input id="empresa"
                        ...
                        name="empresa" type="text" value="{{ old('empresa') }}" autocomplete="off" />
                ...
                <div>
                    ...
                    <input id="persona_contacto"
                        ...
                        name="contacto" type="text" value="{{ old('contacto') }}" autocomplete="off" />
                ...
                <div>
                    ...
                    <input id="telefono"
                        class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center pl-3 text-sm border-gray-300 rounded border"
                        name="telefono" type="number" value="{{ old('telefono') }}" autocomplete="off" />
                </div>

                <!-- correo -->
                <div>
                    <label for="correo" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                        Correo:
                    </label>
                    <input id="correo"
                        class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center pl-3 text-sm border-gray-300 rounded border"
                        name="correo" type="text" value="{{ old('correo') }}" autocomplete="off" />
                </div>
                ...
                <div>
                    ...
                    <input id="direccion"
                        class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center pl-3 text-sm border-gray-300 rounded border"
                        name="direccion" type="text" value="{{ old('direccion') }}" autocomplete="off" />
                </div>
                ...
                <div>
                    ...
                    <input id="tipo"
                        class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center pl-3 text-sm border-gray-300 rounded border "
                        autocomplete="off" name="tipo" value="{{ old('tipo') }}" type="text" />
                </div>
