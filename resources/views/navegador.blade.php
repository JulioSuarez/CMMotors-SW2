                ...
                @can('dashboard.index')
                    ...
                    <li>
                        <a href="{{ Route('Dashboard') }}" id="a_dashboard"
                            class="relative flex flex-row items-center h-11 text-white-600 pr-6  border-r-2 border-gray-800
                             hover:bg-blue-800 hover:border-blue-500 hover:text-white-800 focus:outline-none
                             dark:hover:border-gray-800 dark:hover:bg-gray-600">
