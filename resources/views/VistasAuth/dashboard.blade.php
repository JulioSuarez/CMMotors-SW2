...
<div class="p-4  bg-gray-100">
    ...
    <script>
        var productosAgrupados = @json($productosAgrupados);
        // console.log(productosAgrupados[1]->x);
        // console.log(productosAgrupados);
        console.log('x: "356", y:', productosAgrupados[0]['y']);
        // console.log('x: name','y:',productosAgrupados[1]['y']);
        // console.log('x:',productosAgrupados[1]['x'],'y:',productosAgrupados[1]['y']);
    ...
    {{-- //////////////////////////////////////////////////////////////////////////////////////////////////// --}}
<div class="p-4 m-4 flex justify-between  bg-gray-100">
...
{{--
    <div class="mt-4 mx-4">
        <div
            ...
            <ul>
                @forelse ($productosAgrupados as $p)
                    <li class="mt-3">
                        <p>{{ $p }}</p>
                    </li>
                @empty
                                ...
                                @foreach ($array as $p)
                                    <tr
                                        ...
                                        <td class="px-0 py-3">
                                            <div class="flex items-center text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold">Proveedor: {{ $p['nombre_proveedor'] }}</p>
                                                    <p class="text-xs text-gray-600 dark:text-gray-400">
                                        ...
                                        {{-- <td>
                                            ...
                                            <p class="text-xs text-gray-600 dark:text-gray-400">
                                                {{ $p['proveedor_direccion'] }} | {{ $p['nombre_proveedor_contacto'] }}
                                                | {{ $p['proveedor_telefono'] }}
                                            </p>
                                        </td> --}}
