...
@section('Contenido')
    <div class="mt-4 mx-4">
        <div class="font-extrabold  text-gray-900 dark:text-gray-200 text-center sm:m-4 m-3 pt-1 text-2xl  sm:text-3xl lg:text-4xl uppercase">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($empleados as $p)
                                <tr
                                    class="text-center bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-900 text-gray-700 dark:text-gray-400">
                                    {{-- <td class="px-4 py-3">
