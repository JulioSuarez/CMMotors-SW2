...
@section('Contenido')
    ...
    <form id="formularioxd" class="" action="{{ Route('Empleado.update', $empleado->ci) }}" method="post">
        @csrf
        @method('PUT')

        <div class="flex flex-col items-center ">
            <h1 class="text-center font-bold text-2xl my-3 sm:my-6"> EDITAR UN EMPLEADO</h1>
            <div class="w-10/12 sm:w-8/12 lg:w-3/4 xl:w-4/6 grid grid-cols-1 lg:grid-cols-2 gap-y-3 lg:gap-x-8 autocompl">

                <div class=" ">
                    <div class="flex justify-between pb-1">
                        <label for="ci" id="ci_label" class="font-semibold"> Cedula Identidad*</label>
                    </div>
                    <div id="ci_div" class="flex items-center border-2 border-gray-300 px-1">
                        <input type="number" name="ci" id="ci_emp" autocomplete="off"
                            class="bg-white outline-none w-full px-2 py-2 dark:bg-gray-700" readonly
                            value="{{ $empleado->ci }}" disabled>
                        <div id="ci_svg">
                ...
                <div class=" ">
                    ...
                    <div id="usuario_div" class="flex items-center border-2 border-gray-300 focus:border-blue-400 px-1">
                        <input type="text" name="usuario" id="usuario_inp" autocomplete="off"
                            class="bg-white outline-none w-full px-2 py-2 dark:bg-gray-700 "
                ...
                <div class=" ">
                    <div class="flex justify-between pb-1">
                        <label for="pass_escrito" id="pass_escrito_label" class="font-semibold pb-1">
                ...
                <div class="lg:row-start-4 lg:col-start-2 ">
                    <div class="flex justify-between pb-1">
                        <label for="password" id="password_label" class="font-semibold pb-1">
                            Confirmen Nueva Contraseña*
                        </label>
                    </div>
                ...
                {{-- <div class="lg:row-start-4 lg:col-start-2 ">
                    <div class="flex justify-between pb-1">
                        <label for="password" id="password_label" class="font-semibold pb-1"> Confirmen
                            Contraseña*</label>
                    </div>
                    <div id="password_div" class="flex items-center border-2 border-gray-300 px-1">
                        <input type="password" name="password" id="password" autocomplete="off"
                ...
                <div class="lg:py-5 px-5 flex flex-col  ">
                    ...
                    <button id="bt_submit" type="submit" class="bg-black text-white rounded-lg py-2 w-full ">
                        Registrar</button>
        ...
        <input type="hidden" id="ventana" name="ventana" value="ventana_edit">

    </form>

    <input type="hidden" id="valor_edit" name="ventana" value="{{  $empleado->id_usuario }}">
