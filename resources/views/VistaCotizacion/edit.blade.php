...
@vite(['resources/js/livewire_events.js'])
    ...
    <form id="form" action="{{ Route('Cotizar.update', $cotizacion->id) }}" method="POST">
        @csrf
        @method('PUT')
        <div class=" w-full   xl:px-4">
            ...
            <div class="py-4 px-6 max-w-full m-5 bg-white rounded-xl ">
                ...
                <h1 class="text-gray-800 text-2xl font-bold text-center tracking-normal leading-tight ">
                    EDITAR UNA COTIZACION
                </h1>
                <p class=" text-gray-500 font-bold mt-2 " for="">Empleado: {{ $cotizacion->nombre }}
                </p>
                <input type="number" name="ci_empleado" id="" value="{{ $cotizacion->ci_empleado }}" hidden>
                ...
                <div class="grid  grid-cols-1 sm:grid-cols-2
                        ...
                        <div class="relative mt-0 mb-1">
                            ...
                            <input
                             ...
                             focus:border focus:border-blue-900  font-normal w-full h-8 flex items-center "
                                ...
                                value="{{ old('ci_cliente', $cotizacion->ci_cliente) }}" />
                        </div>
                    </div> <!-- primera caja -->
                    ...
                    <div>
                        ...
                        <input id="cotizacion"
                            ...
                            name="cotizacion" type="number" autocomplete="off "
                            value="{{ old('cotizacion', $cotizacion->nro_coti) }}" />  <!--readonly-->
                    </div>
                    ...
                    <div class="">
                        ...
                        <input id="fecha_realizada"
                            ...
                            name="fecha_realizada" type="date" autocomplete="off"
                            value="{{ old('fecha_realizada', $cotizacion->fecha_realizada) }}" />
                    </div>
                    ...
                    <div class=''>
                        ...
                        <input id="fecha_validez"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="fecha_validez" type="date" autocomplete="off"
                    ...
                    <div class=''>
                        <div class="flex justify-between">
                            <label for="atencion" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                                Atencion:
                            </label>
                        </div>
                        <input id="atencion"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="atencion" type="text" autocomplete="off"
                            value="{{ old('atencion', $cotizacion->atencion) }}" />
                    </div>

                    <div class=''>
                        <div class="flex justify-between">
                            <label for="referencia" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                                Referencia:
                            </label>
                        </div>
                        <input id="referencia"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="referencia" type="text" autocomplete="off"
                            value="{{ old('referencia', $cotizacion->referencia) }}" />
                    </div>
                ...
                <table class="table-fixed border-gray-300 border">
                    <thead class="text-xs  font-semibold uppercase text-gray-600 bg-gray-300">
                        <tr>
                            ...
                            <th class=" xl:px-3">
                                <div class="font-semibold text-center">Tiempo de Entrega</div>
                            </th>
                            <th class=" px-3">
                        ...
                        @for ($i = 1; $i <= $len; $i++)
                            <tr class="trtr  " id="tr{{ $i }}">
                                <td class=" border border-gray-300   lg:w-20 xl:w-28">
                                    <input type="number" class="outline-none text-center font-medium text-black w-full "
                                ...
                                <td class="border border-gray-300">
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $detalles[$i - 1]->detalle_co }}">
                                </td>
                                ...
                                {{-- @DD('holla!!'.($detalles[$i - 1]->tiempo_entrega)) --}}
                                <td class="border border-gray-300 text-black text-center">
                                    <input class=" outline-none w-24  text-center" type="text" name="tiempo_entrega[]"
                                         placeholder="---" value="{{$detalles[$i - 1]->tiempo_entrega}} ">
                                </td>
            ...
            <div class="flex justify-between pt-1 px-1">
                ...
                <div class=" m-2 xl:mr-5 sm:mr-3 text-sm  ">
                    ...
                    <input class="w-28 h-7 bg-gray-200 text-black text-center border-2  rounded-lg  border-gray-400"
                        type="number" name="monto_total" id="monto_total" value="{{ $cotizacion->monto_total }}"
                        readonly step="0.01">
                    ...
                    <div class="flex justify-end m-1 mr-5">
                        <label class="text-black" for="">Descuento: %
                            <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" type="number"
                                value="{{ $cotizacion->descuento }}" id="bt_descuento" min="0" name="descuento">
                ...
                <div class="flex justify-end m-1 mr-5">
                    <label class="text-black" for="">Monto Total: Bs
                        <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" id="totalBs"
                            type="number" value="{{ $cotizacion->total_en_bolivianos }}" name="total_en_bolivianos"
                            step="0.01" readonly>
                ...
                <div class="flex justify-end m-1 mr-5">
                    <label class="text-black" for="">Monto Total: $us
                        ...
                        <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" id="totalSus"
                            type="number" value="{{ $cotizacion->total_en_dolares }}" name="total_en_dolares"
                            step="0.01" readonly>
                    </label>
                </div>
        ...
        <input type="hidden" id="antes" value="{{$cotizacion->nro_coti}}">
