...
@section('Contenido')
   ...
   {{-- <div class="lg:bg-blue-500 md:bg-red-300 xl:bg-yellow-400 2xl:bg-purple-600 sm:bg-black bg-gray-400">
    ...
    <form id="form" action="{{ Route('Cotizar.store') }}" method="POST">
        @csrf
        @method('POST')
        <div class=" w-full  xl:px-4">
            <!--container max-w-lg-->

            <div class="py-4 px-6 max-w-full m-5 bg-white rounded-xl ">
                <!--container max-w-lg -->

                <h1 class="text-gray-800 font-lg font-bold text-center tracking-normal leading-tight ">
                    REALIZAR UNA COTIZACION
                </h1>
                {{-- <p class=" text-gray-500 font-bold mt-2 " for="">Empleado: {{ $empleado->nombre }}
                    {{ $empleado->apellido }} </p> --}}

                <input type="number" name="ci_empleado" id="" value="{{ $empleado->ci }}" hidden>
                <input type="text" name="ventana" id="" value="create_cotizacion" hidden>


                <div class="grid  grid-cols-1 sm:grid-cols-2
                            sm:gap-x-8 lg:gap-x-16 gap-y-4">
                    <div class="">
                    ...
                    <div>
                        <div class="flex justify-between">
                            <label for="cotizacion" class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                                Nro Cotizacion:
                            </label>
                            <p id="cotizacion_error" class="text-xs pt-0.5 text-red-500 font-semibold dark:font-normal"> </p>

                            <p id="p_cotizar_existe"> </p>
                        </div>
                        <input id="cotizacion"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 w-full h-8  text-xl pl-7  border-gray-300 rounded border font-semibold "
                            name="cotizacion" type="number" autocomplete="off" value="{{$coti_may }}" />
                    </div>
                    ...
                    <div class="relative">
                        ...
                        @livewire('autorelleno-cliente')
                    </div>

                    <div class="">
                        <div class="flex justify-between">
                            <label for="fecha_realizada"
                                class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                                Fecha Realizada:
                            </label>
                            <p id="fecha_realizada_error" class="text-xs pt-0.5 text-red-500 font-semibold dark:font-normal"> </p>

                        </div>
                        <input id="fecha_realizada"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="fecha_realizada" type="date" autocomplete="off" value="{{ old('fecha_realizada',$fe) }}"  />
                    </div>
                    ...
                    <div>
                        ...
                        <input id="telefono"
                            ...
                            name="telefono" type="number" autocomplete="off" value="{{ old('telefono') }}" />
                    </div>
                    ...
                    <div class=''>
                        <div class="flex justify-between">
                            <label for="fecha_validez"
                                class="text-gray-800 text-sm font-bold leading-tight tracking-normal">
                                Fecha Validez
                            </label>
                            <p class="text-blue-400 text-xs lg:text-sm px-1 mr-2  sm:pr-3 font-semibold rounded-xl  w-max">
                                *Nota: + 7 dias por defecto (Editable)
                            </p>
                            <p id="fecha_validez_error" class="text-xs pt-0.5 text-red-500 font-semibold dark:font-normal"> </p>

                        </div>
                        <input id="fecha_validez"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="fecha_validez" type="date" autocomplete="off" value="{{ old('fecha_validez',$fe2) }}" />
                    </div>
                    ...
                    <div class=''>
                        ...
                        <input id="atencion"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="atencion" type="text" autocomplete="off" value="{{ old('atencion') }}" />
                    </div>
                    ...
                    <div class=''>
                        ...
                        <input id="referencia"
                            class="mt-0 mb-1 text-gray-600 focus:outline-none focus:border focus:border-blue-900 font-normal w-full h-8 flex items-center px-5 text-sm border-gray-300 rounded border"
                            name="referencia" type="text" autocomplete="off" value="{{ old('referencia') }}" />
                    </div>
        ...
        <div id="div_prod_no_encontrado"
            ...
            <p id="p_no_encontrado" class="text-red-400"> </p>
        </div>
        ...
        <div class=" max-w-full  xl:mx-9 mx-5 rounded-lg  bg-white shadow-lg border-black border-2 ">
                ...
                <table class="table-fixed border-gray-300 border">
                    <thead class="text-xs  font-semibold uppercase text-gray-600 bg-gray-300">
                        <tr>
                            ...
                            <th class=" xl:px-3">
                                <div class="font-semibold text-center">Tiempo Entrega</div>
                            </th>
                            <th class=" px-3">
                    ...
                    <tbody id="tabla" class="text-base ">
                        ...
                        <tr class="trtr" id="tr1">
                            ...
                            <td class="border border-gray-300  h-11 w-full flex justify-center">
                               ...
                               @include('VistaVentas.modelProductos')

                                <button id="bt_abrir_modal1" type="button"
                            ...
                            <td class="border border-gray-300 text-black text-center">
                                <input class="outline-none w-24 text-center"
                                 type="text" name="tiempo_entrega[]" value="" placeholder="---">
                            </td>


                            <td class="border border-gray-300"  id="td_cantidad_1">
                                <div class="flex  justify-center w-full h-full items-center">
                                    ...
                                    <input type="number" class=" outline-none text-center font-medium w-10 px-1 text-black "
                                        name="cantidad[]" id="cantidad1" value="1" min="1">
                            ...
                            <td class="border border-gray-300" id="td_precio_1">
                                <input class="outline-none text-center font-medium text-black w-20 xl:w-28 p-1"
                                    name="precio[]" id="precio1" value="0" type="number" step="0.01"
                                    min="0">
                            </td>
                            <td class="border border-gray-300">
                                <input class="outline-none text-center  font-medium text-black w-24 xl:w-28  p-1"
                                    name="subtotal[]" id="subtotal1" value="0" type="number" step="0.01"
                                    readonly min="0">
                            </td>
                            ...
                            <td class="border border-gray-300 text-center">
                                ...
                                <button id="button_eliminar1" class=" font-medium text-black    ">
            ...
            <div class="flex justify-between pt-1 px-1">
                ...
                <div class=" m-2 xl:mr-5 sm:mr-3 text-sm  ">
                    ...
                    <input class="w-28 h-7 bg-gray-200 text-black text-center border-2  rounded-lg  border-gray-400"
                        type="number" name="monto_total" id="monto_total" value="0"  step="0.01">
                ...
                <div class=" row-start-1 sm:col-start-2  row-span-3">
                        ...
                        <div class="flex justify-end m-1 mr-5">
                            <label class="text-black" for="">Descuento: %
                                <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" type="number"
                                    value="0" id="bt_descuento" min="0" name="descuento">
                    ...
                    <div class="flex justify-end m-1 mr-5">
                        <label class="text-black" for="">Monto Total: Bs
                            <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400"
                            id="totalBs" type="number" value="0" name="total_en_bolivianos" step="0.01"  readonly>
                    ...
                    <div class="flex justify-end m-1 mr-5">
                        <label class="text-black" for="">Monto Total: $us
                            ...
                            <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400"
                             id="totalSus" type="number" value="0" name="total_en_dolares" step="0.01"  readonly>
                        </label>
                    </div>
                    ...
                    <div class="flex flex-row-reverse py-2   rounded-b-lg">
                        ...
                        <div class="flex-initial">
                            <button type="button"
                                ...
                                <a href="{{ route('Cotizar.index') }}">Cancelar</a>
                            </button>
                        </div>
                    </div>
            ...
            <input type="hidden" id="verificar_solo_vista_Cotizacion" value="si esta en cotizacoin">
            <input type="hidden" id="antes" value="0">
    ...
    <script src="{{ asset('js/Proveedor/CotizacionExiste.js') }}"></script>
