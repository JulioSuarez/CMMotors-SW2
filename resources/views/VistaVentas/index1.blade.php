...
@section('Contenido')
    ...
    <div id="div_error"
        class="animate-bounce fixed z-50 hidden top-12 right-3 py-2 px-3 text-white w-fit  rounded-lg bg-red-500">
                        ...
                        dark:hover:bg-gray-900 text-gray-700 dark:text-gray-200">
                            ...
                            <td class=" pr-2">
                                ...
                                @if ($ventas[$i]->id_venta == 0)
                                    <input type="hidden" id="venta_id{{ $i }}"
                                        value="{{ $ventas[$i]->id }}">
                            ...
                            <td class=" py-2 text-xs">
                                <div class=" flex justify-around">
                                    ...
                                    @can('ventas.destroy')
                                        ...
                                        <div class=" relative">
                                            <div id="modal_eliminar{{ $i }}"
                                                class="absolute right-10 -top-14 hidden animacion-appear bg-white h-32 w-56 m-2 p-2 py-3 rounded-lg shadow-2xl shadow-gray-400 border ">

                                                <h3 class="font-bold uppercase"> Eliminar la venta nro: {{ $ventas[$i]->id }}
                                                </h3>
    ...
    <div id="difuminar_vista"
        class="fixed z-50 top-0 left-0 w-screen h-screen bg-black bg-opacity-70
