...
@vite(['resources/js/livewire_events.js'])
    ...
    <form id="form" action="{{ Route('Venta.update', $venta->id) }}" method="POST">
        @csrf
        @method('PUT')
                            ...
                            <tr class="trtr  " id="tr{{ $i }}">
                                ...
                                <td class="border border-gray-300 ">
                                    <input type="text"
                                        ...
                                        name="unidad_co[]" value="{{ $detalles[$i - 1]->unidad }}"
                                        id="unidad_co{{ $i }}" autocomplete="off">
                                ...
                                <td class="border border-gray-300">
                                    <input type="text"
                                        ...
                                        autocomplete="off" value="{{ $detalles[$i - 1]->detalles }}">
                                </td>
                                ...
                                <td class="border border-gray-300 text-center ">
                                    <input class="outline-none text-center font-medium text-black w-20 xl:w-28 p-1"
                                        name="costop[]" id="costop1"type="number" step="0.01" min="0"
                                        value="{{ $detalles[$i - 1]->costo_producto }}">
                                </td>
