...
@section('Contenido')
    ...
    <style>
        ...
        .div-parent:focus-within {
            border-color: #374151; /* Cambia el color del borde cuando el input está enfocado */
        }
    ...
    <form id="form" action="{{ Route('Venta.store') }}" method="POST">
        ...
        <div class="w-full xl:px-4">
            ...
            <div class=" py-4 px-6 max-w-full m-5 bg-white rounded-xl ">
                ...
                <input type="text" name="ventana" id="" value="create_ventas" hidden>

                <div class="flex justify-between ">
                    <label for="ci_autocomplete"
                        class="items-end text-gray-800  text-sm font-bold leading-tight tracking-normal flex divide-x-8">
                ...
                <input id="telefono"
                    class="mt-0 mb-1 text-gray-600 outline-none focus:border-black  font-normal w-full h-8 flex items-center pl-3 text-sm border-gray-300 rounded border"
                ...
                <input id="empresa"
                    ...
                    name="empresa" type="text" autocomplete="off" />
        ...
        <div id="div_prod_no_encontrado"
            ...
            <p id="p_no_encontrado" class="text-red-500 font-semibold"> </p>
        </div>
        ...
        <div class=" max-w-full  xl:mx-9 mx-5 rounded-lg  bg-white shadow-lg border-black border-2 ">
                        ...
                        <tr class="trtr" id="tr1">
                            ...
                            <td class="border border-gray-300" id="td_cantidad_1">
                                <div class="flex  justify-center  w-full h-full items-center">
                                    ...
                                    <input type="number"
                                        class="outline-none  text-center font-medium w-10 px-1 text-black  "
                            ...
                            <td class="border border-gray-300 text-center ">
                                <input class="outline-none text-center font-medium text-black w-20 xl:w-28 p-1"
                                    name="costop[]" id="costop1" value="0" type="number" step="0.01"
                                    min="0">
                            </td>

                            <td class="border border-gray-300  text-center " id="td_precio_1">
                                <input class="outline-none text-center font-medium text-black w-20 xl:w-28  p-1"
            ...
            <div class="flex justify-between pt-1 px-1">
                <div class="flex-initial ml-1 ">
                    <button type="submit" id="button_adicionar"
                        ...
                        <span class=" sr-only sm:not-sr-only text-xs sm:text-base ml-1  text-green-700">Adicionar</span>
                    </button>
                ...
                <div class=" m-2 xl:mr-5 sm:mr-3 text-sm  ">
                    ...
                    <input class="w-28 h-7 bg-gray-200 text-black text-center  border-2 rounded-lg  border-gray-400"
                        type="number" name="monto_total" id="monto_total" value="0" readonly step="0.01">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2">
                <div class="flex flex-col ml-3 ">
                    ...
                    <textarea name="nota" class="p-1 border border-gray-700 text-xs text-black  mx-5  mb-3  h-16 outline-none "> Al momento de emitir su Orden de Compra, favor de adjutar la presente cotización.</textarea>
                </div>

                {{-- datos generales --}}
                <div class=" p-2  ">
                    <button id="boton_abrir" type="button"
                        class="flex justify-center w-full bg-cyan-800 text-gray-200 py-1 pl-3 border border-black rounded">
                        DATOS GENERALES
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor" class="w-12 h-6  ">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div id="div_menu" class="hidden bg-white  mt-1 py-2 px-4 border border-black rounded">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="cuenta"
                                value="NRO DE CUENTA BS. 2000121455 BANCO NACIONAL DE BOLIVIA (BNB) "
                                class="border-b border-gray-900 text-xs text-black max-w-full mr-5 pl-5   mb-3  outline-none">
                        </div>
                        ...
                        <div class="flex flex-col ">
                            <div class="flex justify-between">
                                ...
                                <p id="tipo_cambio_error"
                                    class="text-xs pt-0.5 text-red-400  font-semibold dark:font-normal mr-5 "> </p>
                            </div>
                    ...
                    <div class="flex justify-end m-1 mr-5">
                        <label class="text-black" for="">Monto Total: Bs
                            <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" id="totalBs"
                                type="number" value="0" name="total_en_bolivianos" step="0.01">
                    ...
                    <div class="flex justify-end m-1 mr-5">
                        <label class="text-black" for="">Monto Total: $us
                            ...
                            <input class="h-6 w-24 sm:w-28 text-center border-b border-gray-400" id="totalSus"
                                type="number" value="0" name="total_en_dolares" step="0.01">
                        </label>
                    </div>
